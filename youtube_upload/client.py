...
class YoutubeUploader():
    ...
    def __init__(
        self,
            ...
            secrets_file_path: object = os.path.join(
                '.',
        ...
        assert isinstance(MAX_RETRIES, object)
    ...
    def authenticate(
        ...
        If a path is given, and the file does not exist at that path, the file will be created at that path. If the 
        file does exist at the given path, it will be used. 
    ...
    def upload(self, file_path: object, options: object = 1, chunksize: object = (-1)) -> object:
        '''
